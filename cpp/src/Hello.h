...
namespace Demo
{
    ...
    public:
        ...
        std::string ping(const std::string & req,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
        ...
        void async_ping(HelloPrxCallbackPtr callback,const std::string &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void coro_ping(HelloCoroPrxCallbackPtr callback,const std::string &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
    ...
    public:
        virtual ~Hello(){}
        virtual std::string ping(const std::string & req,tars::TarsCurrentPtr current) = 0;
        ...
        int onDispatch(tars::TarsCurrentPtr _current, vector<char> &_sResponseBuffer)
        {
            ...
            switch(r.first - __Demo__Hello_all)
            {
                case 0:
                {
                    ...
                    std::string _ret = ping(req, _current);
