...
func (_obj *Test) Ping(req string, _opt ...map[string]string) (ret string, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 0, "ping", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Test) PingWithContext(tarsCtx context.Context, req string, _opt ...map[string]string) (ret string, err error) {
...
//PingOneWayWithContext is the proxy function for the method defined in the tars file, with the context
func (_obj *Test) PingOneWayWithContext(tarsCtx context.Context, req string, _opt ...map[string]string) (ret string, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 1, "ping", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Test) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *Test) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *Test) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *Test) AddServant(imp _impTest, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *Test) AddServantWithContext(imp _impTestWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impTest interface {
	Ping(req string) (ret string, err error)
}
type _impTestWithContext interface {
	Ping(tarsCtx context.Context, req string) (ret string, err error)
}
...
func (_obj *Test) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "ping":
		...
		if _withContext == false {
			_imp := _val.(_impTest)
			_funRet_, err = _imp.Ping(req)
		} else {
			_imp := _val.(_impTestWithContext)
			_funRet_, err = _imp.Ping(tarsCtx, req)
		}
